...
<body>
	...
	<div class="banner">
		...
		<ul>
			...
			<li style="background-image: url('sources/images/banner4.jpg');">
				<!-- <div class="inner">
					<h1>
						<b>智能餐饮管理系统</b>
					</h1>
...
<script type="text/javascript">
	...
	$(function() {
	 ...
	 $('#login-button').click(function(){
	 		if(form.find("[name='password']").val()=="" || form.find("[name='password']").val()=="" || form.find("[name='password']").val()==""){
